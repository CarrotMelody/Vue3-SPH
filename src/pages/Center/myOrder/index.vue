  ...
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="orders">
        <table
          class="order-item"
          v-for="order in data.myOrder.records"
          :key="order.id"
        >
          <thead>
            <tr>
      ...
      <div class="choose-order">
        <el-pagination
          ...
          :total="data.myOrder.total"
          :page-size="data.limit"
          :current-page="data.page"
          @update:current-page="getPageNo"
        />
      </div>
    </div>
    <!--猜你喜欢-->
...
export default {
  ...
  setup() {
    ...
    const getData = async () => {
      ...
      let results = await reqMyOrderList(page, limit);
      if (results.code === 200) {
        data.myOrder = results.data;
      }
    };
